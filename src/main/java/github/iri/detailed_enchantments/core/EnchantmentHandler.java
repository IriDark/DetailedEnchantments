...
public class EnchantmentHandler{
    ...
    public static void handle(GuiGraphics guiGraphics, int mouseX, int mouseY, Enchantment enchantment, List<Component> list, ResourceLocation key){
        ...
        component = Optional.of(new EnchantmentComponent(descriptionText.copy(), enchantment.getRarity(), texture, enchantment.getMaxLevel(), enchantment.isTradeable(), getCachedIncompatibilities(enchantment)));
        guiGraphics.renderTooltip(Minecraft.getInstance().font, list, component, mouseX, mouseY);
    }
